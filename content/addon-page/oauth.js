...
*/
OAuth2.prototype.finishAuth = function(href = false) {
  ...
  try {
    authorizationCode = that.adapter.parseAuthorizationCode((href !== false)?href:window.location.href);
